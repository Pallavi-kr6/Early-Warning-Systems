"""
Heatwave Model Training Script
Uses Kaggle India Heatwave Dataset to train the neural network
"""
...
# Configuration
DATASET_PATH = 'india_heatwave_dataset.csv.csv'
MODEL_PATH = 'models/heatwave_prediction_model.h5'
SCALER_PATH = 'models/heat_scaler.pkl'

def download_dataset():
    """Download dataset from Kaggle using kaggle-cli"""
    print("=" * 60)
    print("HEATWAVE MODEL TRAINING")
    print("=" * 60)
    ...
    try:
        ...
        kaggle.api.dataset_download_files(
            'ashirwadk24/india-heatwave-dataset',
            path='.',
            unzip=True
        )
        ...
        print("https://www.kaggle.com/datasets/ashirwadk24/india-heatwave-dataset")
        print("Extract and place the CSV file in the project root folder")
        return False
...
def load_and_prepare_data():
    ...
    if not os.path.exists(DATASET_PATH):
        ...
        print("\nManual steps:")
        print("1. Download from: https://www.kaggle.com/datasets/ashirwadk24/india-heatwave-dataset")
        print("2. Extract the CSV file")
        print("3. Place it as 'india_heatwave_dataset.csv' in:", os.path.abspath('.'))
...
def preprocess_data(df):
    ...
    # For India heatwave dataset - use temperature and humidity based features
...
def evaluate_model(model, X_test, y_test):
    ...
    if (precision + recall) > 0:
        ...
        print(f"  F1-Score: N/A (no positive predictions)")
